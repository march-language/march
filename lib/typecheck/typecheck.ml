...
let builtin_ctors : (string * ctor_info) list =
  ...
  let some_ci  = { ci_type = "Option"; ci_params = ["a"];      ci_arg_tys = [mk_var "a"] } in
  let none_ci  = { ci_type = "Option"; ci_params = ["a"];      ci_arg_tys = [] } in
  let ok_ci    = { ci_type = "Result"; ci_params = ["a"; "e"]; ci_arg_tys = [mk_var "a"] } in
  let err_ci   = { ci_type = "Result"; ci_params = ["a"; "e"]; ci_arg_tys = [mk_var "e"] } in
  let nil_ci   = { ci_type = "List";   ci_params = ["a"];      ci_arg_tys = [] } in
  let cons_ci  = { ci_type = "List";   ci_params = ["a"];
                   ci_arg_tys = [mk_var "a"; mk_list_ty "a"] } in
