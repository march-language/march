...
type env = {
  ...
  cap_narrow_sites :
    (Typecheck_types.Ast.span *
     Typecheck_types.ty)
    list ref;
  node_send_sites : (Typecheck_types.Ast.span * string * Typecheck_types.ty) list ref;
  json_codecs : Typecheck_types.ty list ref;
  (** Every `Node.send` / `Node.enqueue` site (span, callee, instantiated arrow); see the .ml. *)
  json_cap_sites :
    (Typecheck_types.Ast.span *
