...
let builtins : builtin list = [
  ...
  { march_name = "native_int_arr_sort"; c_name = None; ret_ty = Some (Tir.TCon ("NativeIntArr", []));
    in_is_builtin = true; declare_sig = Some "declare ptr    @native_int_arr_sort(ptr %arr)" };
  ...
  { march_name = "delivery_origin_set"; c_name = Some "march_sched_delivery_origin_set"; ret_ty = Some Tir.TUnit;
    in_is_builtin = true; declare_sig = Some "declare void @march_sched_delivery_origin_set(i64 %conn, i64 %seq)" };
  { march_name = "delivery_origin_clear"; c_name = Some "march_sched_delivery_origin_clear"; ret_ty = Some Tir.TUnit;
    in_is_builtin = true; declare_sig = Some "declare void @march_sched_delivery_origin_clear()" };
  { march_name = "delivery_failed_watch"; c_name = Some "march_delivery_failed_watch"; ret_ty = Some Tir.TUnit;
    in_is_builtin = true; declare_sig = Some "declare void @march_delivery_failed_watch(ptr %clo)" };
