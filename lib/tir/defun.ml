...
let builtin_names : StringSet.t =
  List.fold_left (fun s n -> StringSet.add n s) StringSet.empty
    [ "+"; "-"; "*"; "/"; "%"; "negate";
      ...
      "tcp_connect"; "tcp_connect_timeout"; "tcp_close"; "tcp_shutdown"; "sleep_ms"; "tcp_listen"; "tcp_accept"; "tcp_accept_timeout"; "tcp_local_port";
      ...
      (* Actor builtins *)
      "actor_call"; "actor_cast"; "actor_reply"; "actor_reply_retain"; "self"; "receive";
