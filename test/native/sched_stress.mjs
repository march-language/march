...
const fib$clo = { _0: ($_, n) => fib(n) };

function spawn_workers(start, count) {
  {
    const $t24113 = (count <= 0);
    if ($t24113 === true) {
      return {  };
    } else {
      return (() => {
        {
          const $p24120 = (() => {
            {
              const $t24117 = { $: "$Clo_$lam24114$3267", _0: $lam24114$apply$3267, _1: start };
              return task_spawn($t24117);
            }
          })();
          {
            const $t24118 = (start + 1);
            {
              const $t24119 = (count - 1);
              return spawn_workers($t24118, $t24119);
            }
          }
        }
      })();
...
const spawn_workers$clo = { _0: ($_, start, count) => spawn_workers(start, count) };

function spawn_batches(batch, n_batches, batch_size) {
  {
    const $t24121 = (batch >= n_batches);
    if ($t24121 === true) {
      return {  };
    } else {
      return (() => {
        {
          const start = (batch * batch_size);
          {
            const $p24125 = (() => {
              {
                const $t24123 = { $: "$Clo_$lam24122$3268", _0: $lam24122$apply$3268, _1: batch_size, _2: start };
                return task_spawn($t24123);
              }
            })();
            {
              const $t24124 = (batch + 1);
              return spawn_batches($t24124, n_batches, batch_size);
            }
          }
        }
      })();
...
const spawn_batches$clo = { _0: ($_, batch, n_batches, batch_size) => spawn_batches(batch, n_batches, batch_size) };
  ...
  (() => {
    {
              ...
              const $t24131 = (() => {
                {
                      ...
                      const $t24128 = (() => {
                        {
                          const $t24127 = (() => {
                            {
                              const $t24126 = String(250000);
                              {
                                const $rc_719 = ("Spawning " + $t24126);
                                return $rc_719;
                              }
                            }
                          })();
                          {
                            const $rc_718 = ($t24127 + " tasks across ");
                            return $rc_718;
                          }
                        }
                      })();
                      {
                        const $t24129 = String(250);
                        {
                          const $rc_717 = ($t24128 + $t24129);
                          return $rc_717;
                        }
                      }
                    }
                  ...
                  {
                    const $rc_716 = ($t24130 + " batches of ");
                    return $rc_716;
                  }
                }
              })();
              {
                const $t24132 = String(1000);
                {
                  const $rc_715 = ($t24131 + $t24132);
                  return $rc_715;
                }
              }
            }
      ...
      return println$String($t24134);
    }
  })();
  spawn_batches(0, 250, 1000);
  {
    const $t24137 = (() => {
      {
        const $t24136 = (() => {
          {
            const $t24135 = String(250000);
            {
              const $rc_713 = ("All batches dispatched — scheduler draining " + $t24135);
              return $rc_713;
            }
          }
        })();
        {
          const $rc_712 = ($t24136 + " tasks");
          return $rc_712;
        }
      }
    })();
    return println$String($t24137);
  }
}
...
function $lam24114$apply$3267($clo, _) {
  {
    const start = (() => {
      return $clo._1;
    })();
...
const $lam24114$apply$3267$clo = { _0: ($_, $clo, _) => $lam24114$apply$3267($clo, _) };

function $lam24122$apply$3268($clo, _) {
  {
    const batch_size = (() => {
      return $clo._1;
    })();
    {
      ...
      return spawn_workers(start, batch_size);
    }
  }
}
const $lam24122$apply$3268$clo = { _0: ($_, $clo, _) => $lam24122$apply$3268($clo, _) };
