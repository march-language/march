...
function main() {
  {
    const $p24132 = { _0: 5, _1: 99 };
    {
      const s = $p24132._0;
      {
            ...
            const $t24114 = (() => {
              {
                const $t24112 = (() => {
                  {
                    const $t24111 = (() => {
                      {
                        const $t24110 = String(s);
                        {
                          const $rc_723 = ("ii=" + $t24110);
                          return $rc_723;
                        }
                      }
                    })();
                ...
                {
                  const $t24113 = String(t);
                  {
                    const $rc_721 = ($t24112 + $t24113);
                    return $rc_721;
                  }
                }
              }
        ...
        {
          const $p24131 = { _0: 0, _1: "tail" };
          {
            const n = $p24131._0;
            {
              const tail = $p24131._1;
              (() => {
                {
                  const $t24118 = (() => {
                    {
                      const $t24117 = (() => {
                        {
                          const $t24116 = (() => {
                            {
                              const $t24115 = String(n);
                              {
                                const $rc_720 = ("pair=" + $t24115);
                                return $rc_720;
                              }
                            }
                          })();
                      ...
                      {
                        const $rc_718 = ($t24117 + tail);
                        return $rc_718;
                      }
                    }
                  })();
                  return println$String($t24118);
                }
              })();
              {
                const loc = { _0: 7, _1: 8 };
                        ...
                        const $t24123 = (() => {
                          {
                            const $t24121 = (() => {
                              {
                                const $t24120 = (() => {
                                  {
                                    const $t24119 = String(u);
                                    {
                                      const $rc_717 = ("local=" + $t24119);
                                      return $rc_717;
                                    }
                                  }
                                })();
                            ...
                            {
                              const $t24122 = String(v);
                              {
                                const $rc_715 = ($t24121 + $t24122);
                                return $rc_715;
                              }
                            }
                          }
                        })();
                        return println$String($t24123);
                      }
                    })();
                    {
                      const $p24129 = { _0: true, _1: 2.5 };
                      {
                        const flag = $p24129._0;
                        {
                          const f = $p24129._1;
                          {
                            const $t24128 = (() => {
                              {
                                ...
                                {
                                  const $t24127 = march_float_to_string(f);
                                  {
                                    const $rc_712 = ($t24126 + $t24127);
                                    return $rc_712;
                                  }
                                }
                              }
                            })();
                            return println$String($t24128);
                          }
                        }
                      }
                    }
