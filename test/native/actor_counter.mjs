...
function __eq_Counter_State(a, b) {
  if (a.value !== b.value) return false;
  return true;
}

function __eq_Counter_Msg(a, b) {
  if (a.$ !== b.$) return false;
  switch (a.$) {
    case "GetValue": {
      if (a._0 !== b._0) return false;
...
function __eq_Counter_Actor(a, b) {
  if (a.$d_dispatch !== b.$d_dispatch) return false;
  if (a.$e_alive !== b.$e_alive) return false;
  if (a.value !== b.value) return false;
  return true;
}

function Counter_Increment($actor, n) {
  {
    const $d_dispatch_v = $actor.$d_dispatch;
    {
      const $e_alive_v = $actor.$e_alive;
      {
        const $sf_value = $actor.value;
        {
          const state = ({ value: $sf_value });
          {
            const $result = (() => {
              {
                const $t24110 = ($sf_value + n);
                return ({ ...state, value: $t24110 });
              }
            })();
            {
              const $nf_value = $result.value;
              (() => {
                return { $: "Counter_Actor", _0: $d_dispatch_v, _1: $e_alive_v, _2: $nf_value };
              })();
              return ":unit";
            }
          }
...
const Counter_Increment$clo = { _0: ($_, $actor, n) => Counter_Increment($actor, n) };

function Counter_dispatch($actor, $msg) {
  switch ($msg.$) {
    case "GetValue": {
      const $GetValue_ref = $msg._0;
      return Counter_GetValue$Counter_Actor$V__($actor, $GetValue_ref);
    }
    case "Increment": {
      const $Increment_n = $msg._0;
      return Counter_Increment($actor, $Increment_n);
    }
  }
}
const Counter_dispatch$clo = { _0: ($_, $actor, $msg) => Counter_dispatch($actor, $msg) };
    ...
    const c = (() => {
      {
        const $raw_actor = (() => {
          {
            const $spawned_i2244 = { $: "Counter_Actor", _0: Counter_dispatch$clo, _1: true, _2: 0 };
            return $spawned_i2244;
          }
        })();
        return spawn($raw_actor);
      }
    })();
    {
      const $p24117 = (() => {
        {
          const $t24111 = { $: "Increment", _0: 5 };
          return send(c, $t24111);
        }
      })();
      {
        const result = (() => {
          {
            const $t24112 = { $: "CallGet" };
            return Actor$call$Pid_V__31684$CallGet$Int(c, $t24112, 5000);
          }
        })();
        (() => {
          switch (result.$) {
            case "Ok": {
              const $f24115 = result._0;
              {
                const v = $f24115;
                {
                  const $t24114 = (() => {
                    {
                      const $t24113 = String(v);
                      {
                        const $rc_712 = ("value=" + $t24113);
                        return $rc_712;
                      }
                    }
                  })();
                  return println$String($t24114);
                }
              }
            }
            case "Err": {
              const $f24116 = result._0;
              return println$String("timeout");
            }
          }
        })();
        return kill(c);
...
function Actor$reply$V__31681$Int(ref_id, result) {
  return actor_reply(ref_id, result);
}
const Actor$reply$V__31681$Int$clo = { _0: ($_, ref_id, result) => Actor$reply$V__31681$Int(ref_id, result) };

function Counter_GetValue$Counter_Actor$V__($actor, ref) {
  {
    const $d_dispatch_v = $actor.$d_dispatch;
    {
      const $e_alive_v = $actor.$e_alive;
      {
        const $sf_value = $actor.value;
        {
          ...
          {
            const $result = (() => {
              Actor$reply$V__31681$Int(ref, $sf_value);
              return state;
            })();
            {
              const $nf_value = $result.value;
...
const Counter_GetValue$Counter_Actor$V__$clo = { _0: ($_, $actor, ref) => Counter_GetValue$Counter_Actor$V__($actor, ref) };

function Actor$call$Pid_V__31684$CallGet$Int(pid, msg, timeout_ms) {
  return actor_call(pid, msg, timeout_ms);
}
const Actor$call$Pid_V__31684$CallGet$Int$clo = { _0: ($_, pid, msg, timeout_ms) => Actor$call$Pid_V__31684$CallGet$Int(pid, msg, timeout_ms) };
