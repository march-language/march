...
function rows() {
  {
    const $t24124 = ({ id: 1, age: 30, active: true });
    {
      const $t24125 = ({ id: 2, age: 25, active: false });
      {
        const $t24126 = ({ id: 3, age: 35, active: true });
        {
          const $t24127 = { $: "Nil" };
          {
            const $t24128 = { $: "Cons", _0: $t24126, _1: $t24127 };
            {
              const $t24129 = { $: "Cons", _0: $t24125, _1: $t24128 };
              return { $: "Cons", _0: $t24124, _1: $t24129 };
            }
          }
        }
      }
              ...
              const $t24136 = (() => {
                {
                  const $t24134 = (() => {
                    {
                      const $t24131 = { $: "$Clo_$lam24130$3267", _0: $lam24130$apply$3267 };
                      {
                        const $t24132 = { $: "Nil" };
                        {
                          const $t24133 = { $: "Cons", _0: $t24131, _1: $t24132 };
                          return { $: "Bx", _0: $t24133 };
                        }
                      }
                    }
                  })();
                  {
                    const $t24135 = (() => {
                      {
                        const $t24124_i2260 = ({ id: 1, age: 30, active: true });
                        {
                          const $t24125_i2261 = ({ id: 2, age: 25, active: false });
                          {
                            const $t24126_i2262 = ({ id: 3, age: 35, active: true });
                            {
                              const $t24127_i2263 = { $: "Nil" };
                              {
                                const $t24128_i2264 = { $: "Cons", _0: $t24126_i2262, _1: $t24127_i2263 };
                                {
                                  const $t24129_i2265 = { $: "Cons", _0: $t24125_i2261, _1: $t24128_i2264 };
                                  return { $: "Cons", _0: $t24124_i2260, _1: $t24129_i2265 };
                                }
                              }
                            }
                          }
                    ...
                    return run$Box$List_R_active_Bool_age_Int_id_Int($t24134, $t24135);
                  }
                }
              })();
              return String($t24136);
            }
          })();
          {
            const $rc_715 = ("stored=" + $t24137);
            return $rc_715;
          }
        }
      })();
      return println$String($t24138);
    }
  })();
  (() => {
    {
              ...
              const $t24146 = (() => {
                {
                  const $t24144 = (() => {
                    {
                      const $t24141 = { $: "$Clo_$lam24139$3268", _0: $lam24139$apply$3268 };
                      {
                        const $t24142 = { $: "Nil" };
                        {
                          const $t24143 = { $: "Cons", _0: $t24141, _1: $t24142 };
                          return { $: "Bx", _0: $t24143 };
                        }
                      }
                    }
                  })();
                  {
                    const $t24145 = (() => {
                      {
                        const $t24124_i2254 = ({ id: 1, age: 30, active: true });
                        {
                          const $t24125_i2255 = ({ id: 2, age: 25, active: false });
                          {
                            const $t24126_i2256 = ({ id: 3, age: 35, active: true });
                            {
                              const $t24127_i2257 = { $: "Nil" };
                              {
                                const $t24128_i2258 = { $: "Cons", _0: $t24126_i2256, _1: $t24127_i2257 };
                                {
                                  const $t24129_i2259 = { $: "Cons", _0: $t24125_i2255, _1: $t24128_i2258 };
                                  return { $: "Cons", _0: $t24124_i2254, _1: $t24129_i2259 };
                                }
                              }
                            }
                          }
                    ...
                    return run$Box$List_R_active_Bool_age_Int_id_Int($t24144, $t24145);
                  }
                }
              })();
              return String($t24146);
            }
          })();
          {
            const $rc_714 = ("computed=" + $t24147);
            return $rc_714;
          }
        }
      })();
      return println$String($t24148);
    }
  })();
  (() => {
    {
              ...
              const $t24155 = (() => {
                {
                  const $t24153 = (() => {
                    {
                      const $t24150 = { $: "$Clo_$lam24149$3269", _0: $lam24149$apply$3269 };
                      {
                        const $t24151 = { $: "Nil" };
                        {
                          const $t24152 = { $: "Cons", _0: $t24150, _1: $t24151 };
                          return { $: "Bx", _0: $t24152 };
                        }
                      }
                    }
                  })();
                  {
                    const $t24154 = (() => {
                      {
                        const $t24124_i2248 = ({ id: 1, age: 30, active: true });
                        {
                          const $t24125_i2249 = ({ id: 2, age: 25, active: false });
                          {
                            const $t24126_i2250 = ({ id: 3, age: 35, active: true });
                            {
                              const $t24127_i2251 = { $: "Nil" };
                              {
                                const $t24128_i2252 = { $: "Cons", _0: $t24126_i2250, _1: $t24127_i2251 };
                                {
                                  const $t24129_i2253 = { $: "Cons", _0: $t24125_i2249, _1: $t24128_i2252 };
                                  return { $: "Cons", _0: $t24124_i2248, _1: $t24129_i2253 };
                                }
                              }
                            }
                          }
                    ...
                    return run$Box$List_R_active_Bool_age_Int_id_Int($t24153, $t24154);
                  }
                }
              })();
              return String($t24155);
            }
          })();
          {
            const $rc_713 = ("literal=" + $t24156);
            return $rc_713;
          }
        }
      })();
      return println$String($t24157);
    }
  })();
  {
    const $t24167 = (() => {
            ...
            const $t24165 = (() => {
              {
                const $t24163 = (() => {
                  {
                    const $t24160 = { $: "$Clo_$lam24158$3270", _0: $lam24158$apply$3270 };
                    {
                      const $t24161 = { $: "Nil" };
                      {
                        const $t24162 = { $: "Cons", _0: $t24160, _1: $t24161 };
                        return { $: "Bx", _0: $t24162 };
                      }
                    }
                  }
                })();
                {
                  const $t24164 = (() => {
                    {
                      const $t24124_i2242 = ({ id: 1, age: 30, active: true });
                      {
                        const $t24125_i2243 = ({ id: 2, age: 25, active: false });
                        {
                          const $t24126_i2244 = ({ id: 3, age: 35, active: true });
                          {
                            const $t24127_i2245 = { $: "Nil" };
                            {
                              const $t24128_i2246 = { $: "Cons", _0: $t24126_i2244, _1: $t24127_i2245 };
                              {
                                const $t24129_i2247 = { $: "Cons", _0: $t24125_i2243, _1: $t24128_i2246 };
                                return { $: "Cons", _0: $t24124_i2242, _1: $t24129_i2247 };
                              }
                            }
                          }
                        }
                  ...
                  return run$Box$List_R_active_Bool_age_Int_id_Int($t24163, $t24164);
                }
              }
            })();
            return String($t24165);
          }
        })();
        {
          const $rc_712 = ("negated=" + $t24166);
          return $rc_712;
        }
      }
    })();
    return println$String($t24167);
  }
}
...
function run$Box$List_R_active_Bool_age_Int_id_Int(box, rows) {
  switch (box.$) {
    case "Bx": {
      const $f24123 = box._0;
      {
        ...
        switch (preds.$) {
          case "Cons": {
            const $f24117 = preds._0;
            const $f24118 = preds._1;
            {
              const p = $f24117;
              return count_keep$List_R_active_Bool_age_Int_id_Int$Fn_R_active_Bool_age_Int_id_Int_Bool$Int(rows, p, 0);
            }
          }
          case "Nil": {
            return -1;
...
const run$Box$List_R_active_Bool_age_Int_id_Int$clo = { _0: ($_, box, rows) => run$Box$List_R_active_Bool_age_Int_id_Int(box, rows) };

function count_keep$List_R_active_Bool_age_Int_id_Int$Fn_R_active_Bool_age_Int_id_Int_Bool$Int(rows, pred, n) {
  switch (rows.$) {
    case "Nil": {
      return n;
    }
    case "Cons": {
      const $f24111 = rows._0;
      const $f24112 = rows._1;
      {
        const t = $f24112;
        {
          const h = $f24111;
          {
            ...
            if ($t24109 === true) {
              return (() => {
                {
                  const $t24110 = (n + 1);
                  return count_keep$List_R_active_Bool_age_Int_id_Int$Fn_R_active_Bool_age_Int_id_Int_Bool$Int(t, pred, $t24110);
                }
              })();
            } else {
              return count_keep$List_R_active_Bool_age_Int_id_Int$Fn_R_active_Bool_age_Int_id_Int_Bool$Int(t, pred, n);
            }
          }
        }
      }
...
const count_keep$List_R_active_Bool_age_Int_id_Int$Fn_R_active_Bool_age_Int_id_Int_Bool$Int$clo = { _0: ($_, rows, pred, n) => count_keep$List_R_active_Bool_age_Int_id_Int$Fn_R_active_Bool_age_Int_id_Int_Bool$Int(rows, pred, n) };

function $lam24130$apply$3267($clo, r) {
  return r.active;
}
const $lam24130$apply$3267$clo = { _0: ($_, $clo, r) => $lam24130$apply$3267($clo, r) };

function $lam24139$apply$3268($clo, r) {
  {
    const $t24140 = r.age;
    return ($t24140 > 28);
  }
}
const $lam24139$apply$3268$clo = { _0: ($_, $clo, r) => $lam24139$apply$3268($clo, r) };

function $lam24149$apply$3269($clo, r) {
  return true;
}
const $lam24149$apply$3269$clo = { _0: ($_, $clo, r) => $lam24149$apply$3269($clo, r) };

function $lam24158$apply$3270($clo, r) {
  {
    const $t24159 = r.active;
    return (!$t24159);
  }
}
const $lam24158$apply$3270$clo = { _0: ($_, $clo, r) => $lam24158$apply$3270($clo, r) };
