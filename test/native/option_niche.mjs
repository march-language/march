...
function safe_div(a, b) {
  {
    ...
    if ($t24108 === true) {
      ...
      return (() => {
        {
          const $t24109 = (a / b);
          return { $: "Some", _0: $t24109 };
        }
      })();
    }
  }
}
const safe_div$clo = { _0: ($_, a, b) => safe_div(a, b) };

function greet(name) {
  switch (name.$) {
    case "Some": {
      const $f24110 = name._0;
      {
        const s = (() => {
          return $f24110;
        })();
        {
          const $rc_712 = ("hello " + s);
          return $rc_712;
        }
      }
    }
...
const greet$clo = { _0: ($_, name) => greet(name) };

function main() {
  (() => {
    {
      const $t24111 = safe_div(10, 2);
      switch ($t24111.$) {
        case "Some": {
          const $f24113 = $t24111._0;
          {
            const n = $f24113;
            {
              const $t24112 = String(n);
              return println$String($t24112);
            }
          }
        }
        case "None": {
          return println$String("none");
        }
      }
    }
  })();
  (() => {
    {
      const $t24114 = safe_div(7, 0);
      switch ($t24114.$) {
        case "Some": {
          const $f24116 = $t24114._0;
          {
            const n = $f24116;
            {
  ...
  (() => {
    {
      const $t24118 = (() => {
        {
          const $t24117 = { $: "Some", _0: "world" };
          {
            const $rc_714 = greet($t24117);
            return $rc_714;
          }
        }
      })();
    ...
    const $t24120 = (() => {
      {
        const $t24119 = { $: "None" };
        {
          const $rc_713 = greet($t24119);
          return $rc_713;
        }
      }
    })();
    return println$String($t24120);
  }
}
