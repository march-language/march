...
function get_assign(conn, key) {
  {
    const find = { $: "$Clo_find$3267", _0: find$apply$3267, _1: key };
    switch (conn.$) {
      case "Conn": {
        const $f24121 = conn._0;
        const $f24122 = conn._1;
        {
          const a = $f24122;
          return find$apply$3267(find, a);
        }
      }
    }
  }
}
const get_assign$clo = { _0: ($_, conn, key) => get_assign(conn, key) };

function assign(conn, key, value) {
  switch (conn.$) {
    case "Conn": {
      const $f24129 = conn._0;
      const $f24130 = conn._1;
      {
        const a = $f24130;
        {
          const b = $f24129;
          {
            const $t24127 = { _0: key, _1: value };
            {
              const $t24128 = { $: "Cons", _0: $t24127, _1: a };
              return { $: "Conn", _0: b, _1: $t24128 };
            }
          }
        }
      }
...
const assign$clo = { _0: ($_, conn, key, value) => assign(conn, key, value) };

function Wrap$render(conn, action, method, _class, render_inner) {
  {
    const tok = get_assign(conn, "_csrf_token");
    {
      const inner = render_inner._0(render_inner);
      {
        const $t24141 = (() => {
          {
            const $t24140 = (() => {
                    ...
                    const $t24138 = (() => {
                      {
                        ...
                        {
                          const $rc_716 = ($t24137 + _class);
                          return $rc_716;
                        }
                      }
                    })();
                    {
                      const $rc_715 = ($t24138 + "|tok=");
                      return $rc_715;
                    }
                  }
                })();
                {
                  const $rc_714 = ($t24139 + tok);
                  return $rc_714;
                }
              }
            })();
...
const Wrap$render$clo = { _0: ($_, conn, action, method, _class, render_inner) => Wrap$render(conn, action, method, _class, render_inner) };
...
function main() {
  {
    const conn0 = (() => {
      {
        const $t24142 = { $: "Nil" };
        return { $: "Conn", _0: "", _1: $t24142 };
      }
    })();
    {
      const conn1 = assign(conn0, "_csrf_token", "SECRET");
      {
        const inner = { $: "$Clo_$lam24143$3273", _0: $lam24143$apply$3273 };
        {
          const $t24144 = Wrap$render(conn1, "/login", "post", "", inner);
          return println$String($t24144);
        }
      }
    }
  }
...
function find$apply$3267($clo, pairs) {
  {
    const find = (() => {
      return $clo;
    })();
    {
      ...
      switch (pairs.$) {
        ...
        case "Cons": {
          const $f24109 = pairs._0;
          const $f24110 = pairs._1;
          {
            const $jp2053_$jp_clo24114 = { $: "$Clo_$jp24113$3268", _0: $jp24113$apply$3268 };
            {
              const $jp2054_$jp_clo24118 = { $: "$Clo_$jp24117$3269", _0: $jp24117$apply$3269$clo, _1: $jp2053_$jp_clo24114 };
              {
                const $jp2055_rest = $f24110;
                const $f24111 = $f24109._0;
                const $f24112 = $f24109._1;
                {
                  const v = $f24112;
                  {
                    const k = $f24111;
                    {
                      ...
                      if ($t24108 === true) {
                        ...
                        return (() => {
                          return find._0(find, $jp2055_rest);
                        })();
                      }
                    }
                  }
...
const find$apply$3267$clo = { _0: ($_, $clo, pairs) => find$apply$3267($clo, pairs) };

function $jp24113$apply$3268($clo) {
  return (() => { throw new Error("non-exhaustive pattern match"); })();
}
const $jp24113$apply$3268$clo = { _0: ($_, $clo) => $jp24113$apply$3268($clo) };

function $jp24117$apply$3269($clo) {
  {
    const $jp_clo24114 = (() => {
      return $clo._1;
    })();
    {
      const $jp_clo24116 = (() => {
        return { $: "$Clo_$jp24115$3270", _0: $jp24115$apply$3270, _1: $jp_clo24114 };
      })();
      return $jp24115$apply$3270($jp_clo24116);
    }
  }
}
const $jp24117$apply$3269$clo = { _0: ($_, $clo) => $jp24117$apply$3269($clo) };

function $jp24115$apply$3270($clo) {
  {
    const $jp_clo24114 = (() => {
      return $clo._1;
    })();
    return $jp_clo24114._0($jp_clo24114);
  }
}
const $jp24115$apply$3270$clo = { _0: ($_, $clo) => $jp24115$apply$3270($clo) };

function $lam24143$apply$3273($clo) {
  return "INNER";
}
const $lam24143$apply$3273$clo = { _0: ($_, $clo) => $lam24143$apply$3273($clo) };
