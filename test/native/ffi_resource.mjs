...
function one() {
  {
    const a = acc_new();
    acc_push._0(acc_push, a, 10);
    acc_push._0(acc_push, a, 32);
    return finish._0(finish, a);
  }
}
const one$clo = { _0: ($_) => one() };
...
const churn$clo = { _0: ($_, n) => churn(n) };
      ...
      const $t24060 = (() => {
        {
          const $t24059 = (() => {
            {
              const $t24058 = live_allocs();
              return ($t24058 - base);
            }
          })();
          return String($t24059);
        }
      })();
      return println$String($t24060);
    }
  }
}
