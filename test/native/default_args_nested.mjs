...
function Inner$greet3(name, loud, suffix) {
  {
    let base;
    if (loud === true) {
      base = (() => {
    ...
    {
      const $rc_712 = (base + suffix);
      return $rc_712;
    }
  }
}
const Inner$greet3$clo = { _0: ($_, name, loud, suffix) => Inner$greet3(name, loud, suffix) };

function Inner$greet_d(name, loud, suffix) {
  {
    let base;
    if (loud === true) {
      base = (() => {
    ...
    {
      const $rc_714 = (base + suffix);
      return $rc_714;
    }
  }
}
const Inner$greet_d$clo = { _0: ($_, name, loud, suffix) => Inner$greet_d(name, loud, suffix) };

function main() {
  (() => {
    {
      const $t24108 = Inner$greet3("NoDef", true, "!");
      return println$String($t24108);
    }
  })();
  {
    const $t24109 = Inner$greet_d("Def", true, "!");
    return println$String($t24109);
  }
}
