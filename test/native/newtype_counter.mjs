  ...
  switch (c.$) {
    case "Counter": {
      const $f24109 = c._0;
      {
        ...
        {
          const $t24108 = (n + 1);
          return { $: "Counter", _0: $t24108 };
        }
      }
    }
  }
}
const bump$clo = { _0: ($_, c) => bump(c) };
...
const unwrap$clo = { _0: ($_, c) => unwrap(c) };

function main() {
  {
    const c = { $: "Counter", _0: 41 };
    {
      const $t24113 = (() => {
        {
          const $t24112 = (() => {
            {
              const $t24111 = bump(c);
              return unwrap($t24111);
            }
          })();
          return String($t24112);
        }
      })();
      return println$String($t24113);
    }
  }
}
