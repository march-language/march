...
let test_scc_impl_hash_group () =
  ...
  let hmod = March_cas.Pipeline.hash_module
               { tm_name = "T"; tm_fns = [even_fd; odd_fd]; tm_types = []; tm_externs = []; tm_exports = []; tm_tests = []; tm_io_fns = [] } in
...
let test_hash_module_independent_fns_two_sccs () =
  ...
  let hmod = March_cas.Pipeline.hash_module
               { tm_name = "T"; tm_fns = [f; g]; tm_types = []; tm_externs = []; tm_exports = []; tm_tests = []; tm_io_fns = [] } in
...
let test_changed_body_causes_cache_miss () =
  ...
  let hmod1 = March_cas.Pipeline.hash_module
                { tm_name = "T"; tm_fns = [fd1]; tm_types = []; tm_externs = []; tm_exports = []; tm_tests = []; tm_io_fns = [] } in
  let hmod2 = March_cas.Pipeline.hash_module
                { tm_name = "T"; tm_fns = [fd2]; tm_types = []; tm_externs = []; tm_exports = []; tm_tests = []; tm_io_fns = [] } in
