...
<!-- GENERATED from specs/lang/parallelism.md by scripts/gen-lang-docs.py. Do not edit this file: edit specs/lang/parallelism.md and run scripts/gen-lang-docs.py. -->
...
RRB `Parallel.psum`/`pcount`/`pany`/`pall`/`preduce` matching to the exact
byte interpreted and compiled (stress-verified 0/15 crashes), the first compiled
