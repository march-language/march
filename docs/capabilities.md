...
<!-- GENERATED from specs/lang/capabilities.md by scripts/gen-lang-docs.py. Do not edit this file: edit specs/lang/capabilities.md and run scripts/gen-lang-docs.py. -->
...
[surface syntax](https://github.com/march-language/march/blob/main/specs/lang/surface-syntax.md)). There is one check, and the cap and the
