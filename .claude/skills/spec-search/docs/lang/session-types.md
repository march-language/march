...
**Two things that sound like guarantees but are not, verified live and filed as open findings** (`specs/todos/`; see the [operational reference](core-march.md) §4.11.6 for the full write-up):
