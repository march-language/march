...
- Doc edits to the language reference go in `specs/lang/capabilities.md` only; `docs/capabilities.md` is generated from it (run `scripts/gen-lang-docs.py`, and commit both). *(Updated 2026-09-22: this line used to say "edit both copies"; the copies were reconciled and `docs/` made generated, see `specs/progress/2026-09-22-docs-lang-duplicate-chapters.md`.)* Run `scripts/check-docs.sh` before committing doc changes.
