# `[P2]` Distributed deploys, build step 8: local reconciler, placement, `forge test --upgrade-from`

**Parent:** [../plans/2026-09-21-distributed-authority-and-deploys-plan.md](../plans/2026-09-21-distributed-authority-and-deploys-plan.md), sections 4.2, 5, 6.6, II.6, II.8, D16, D19, D21.
...
settling period, local-first offers. (Automatic drain at loop boundaries, D27, landed
separately: [../progress/2026-09-24-dd-d27-session-drains.md](../progress/2026-09-24-dd-d27-session-drains.md).)
`forge test --upgrade-from <ref>`:
