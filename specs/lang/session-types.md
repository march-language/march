...
**Two gaps remain, both deliberately out of scope of the fixes above** (filed in `specs/todos/`; see the [operational reference](https://github.com/march-language/march/blob/main/specs/lang/core-march.md) §4.11.6 for the full write-up):
