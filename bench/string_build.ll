...
case_default2:
  ...
  store ptr %hp11, ptr %$t577.addr
  %ld17 = load i64, ptr %$t575.addr
  %ld18 = load ptr, ptr %$t577.addr
...
entry:
  ...
  store ptr %hp21, ptr %$t578.addr
  %ld23 = load i64, ptr %n.addr
  %ld24 = load ptr, ptr %$t578.addr
  %cr25 = call ptr @build(i64 %ld23, ptr %ld24)
  %$t579.addr = alloca ptr
  store ptr %cr25, ptr %$t579.addr
  %ld26 = load ptr, ptr %$t579.addr
  ...
  store i64 %cr30, ptr %$t580.addr
  %ld31 = load i64, ptr %$t580.addr
  %cr32 = call ptr @march_int_to_string(i64 %ld31)
  %$t581.addr = alloca ptr
  store ptr %cr32, ptr %$t581.addr
  %ld33 = load ptr, ptr %$t581.addr
